-- PostgreSQL migration: llm_feedback + llm_prompt_suggestions tables
-- Converted from SQLite migrations 033_llm_feedback.sql + 034_feedback_context.sql
...
CREATE TABLE IF NOT EXISTS llm_feedback (
  ...
  -- Added in 034_feedback_context.sql
...
CREATE TABLE IF NOT EXISTS llm_prompt_suggestions (
  ...
  evidence_feedback_ids JSONB NOT NULL DEFAULT '[]',
