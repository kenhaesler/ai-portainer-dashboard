...
// Mock getMovingAverage dependency (DI pattern — no longer imports from @dashboard/observability)
...
describe('anomaly-detector', () => {
  ...
  describe('detectAnomaly', () => {
    it('should return null when insufficient samples', async () => {
      ...
      const result = await detectAnomaly('container-1', 'test-container', 'cpu', 60, mockGetMovingAverage);
    ...
    it('should return null when getMovingAverage not provided', async () => {
    ...
    it('should detect anomaly when z-score exceeds threshold', async () => {
      ...
      const result = await detectAnomaly('container-1', 'test-container', 'cpu', 80, mockGetMovingAverage);
    ...
    it('should handle zero standard deviation with same value as mean', async () => {
      ...
      const result = await detectAnomaly('container-1', 'test-container', 'cpu', 50, mockGetMovingAverage);
    ...
    it('should handle zero standard deviation with different value', async () => {
      ...
      const result = await detectAnomaly('container-1', 'test-container', 'cpu', 55, mockGetMovingAverage);
    ...
    it('should include container information in result', async () => {
      ...
      const result = await detectAnomaly('container-123', 'my-web-app', 'memory', 60, mockGetMovingAverage);
    ...
    it('should include timestamp in result', async () => {
      ...
      const result = await detectAnomaly('container-1', 'test', 'cpu', 60, mockGetMovingAverage);
    ...
    it('should handle edge case at exact threshold', async () => {
      ...
      const result = await detectAnomaly('container-1', 'test-container', 'cpu', 75, mockGetMovingAverage);
    ...
    it('should handle very small deviations', async () => {
      ...
      const result = await detectAnomaly('container-1', 'test-container', 'cpu', 50.0001, mockGetMovingAverage);
    ...
    it('should handle different metric types', async () => {
      ...
      const cpuResult = await detectAnomaly('c1', 'test', 'cpu', 60, mockGetMovingAverage);
      const memoryResult = await detectAnomaly('c1', 'test', 'memory', 60, mockGetMovingAverage);
      const networkResult = await detectAnomaly('c1', 'test', 'network_rx', 60, mockGetMovingAverage);
    ...
    it('should call getMovingAverage with correct parameters', async () => {
      ...
      await detectAnomaly('my-container-id', 'container-name', 'cpu', 55, mockGetMovingAverage);
