...
export const SpanSchema = z.object({
  ...
  url_scheme: z.string().nullable().optional(),
  network_transport: z.string().nullable().optional(),
  network_protocol_name: z.string().nullable().optional(),
  network_protocol_version: z.string().nullable().optional(),
  net_peer_name: z.string().nullable().optional(),
  net_peer_port: z.number().nullable().optional(),
  host_name: z.string().nullable().optional(),
  os_type: z.string().nullable().optional(),
  process_pid: z.number().nullable().optional(),
  process_executable_name: z.string().nullable().optional(),
  process_command: z.string().nullable().optional(),
  telemetry_sdk_name: z.string().nullable().optional(),
  telemetry_sdk_language: z.string().nullable().optional(),
  telemetry_sdk_version: z.string().nullable().optional(),
  otel_scope_name: z.string().nullable().optional(),
  otel_scope_version: z.string().nullable().optional(),
  created_at: z.string(),
});
