...
const navigation: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: 'AI Stack Overview', to: '/stacks', icon: Layers },
    ],
  },
  {
    title: 'Containers',
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'AI eBPF Coverage', to: '/ebpf-coverage', icon: Bug },
  ...
  },
  {
    title: 'Operations',
    items: [
      { label: 'AI Log Viewer', to: '/logs', icon: ScrollText },
      ...
      { label: 'AI Reports', to: '/reports', icon: FileBarChart },
