...
export const DEFAULT_SETTINGS = {
  ...
  authentication: [
    ...
    { key: 'oidc.allow_unmapped_viewer', label: 'Grant viewer role to all IDP users', description: 'When on, any IDP user whose groups match no mapping is granted viewer access. When off, only users in a defined group (or a * wildcard mapping) can sign in — everyone else is denied. Local auth is unaffected.', type: 'boolean', defaultValue: 'false' },
