...
export const themeOptions: { value: Theme; label: string; description: string }[] = [
  ...
  { value: 'apple-light', label: 'Apple Light', description: 'Clean Apple-style light theme' },
  { value: 'apple-dark', label: 'Apple Dark', description: 'Sleek Apple-style dark theme' },
