...
> **Keep in sync:** This file shares rules with `AGENTS.md` and `GEMINI.md`. When updating mandatory rules, git workflow, or security requirements, apply the same change to all three files.
